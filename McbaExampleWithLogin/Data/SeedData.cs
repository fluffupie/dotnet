    ...
    public static void Initialize(IServiceProvider serviceProvider)
    {
        ...
        context.Transactions.AddRange(
            new Transaction
            {
                ...
                TransactionTimeUtc = DateTime.ParseExact("02/01/2026 08:00:00 PM", format, null)
            },
            new Transaction
            {
                TransactionType = TransactionType.Deposit,
                ...
                TransactionTimeUtc = DateTime.ParseExact("02/01/2026 08:30:00 PM", format, null)
            },
            new Transaction
            {
                TransactionType = TransactionType.Deposit,
                ...
                TransactionTimeUtc = DateTime.ParseExact("02/01/2026 08:45:00 PM", format, null)
            },
            new Transaction
            {
                TransactionType = TransactionType.Deposit,
                ...
                TransactionTimeUtc = DateTime.ParseExact("02/01/2026 09:00:00 PM", format, null)
            },
            new Transaction
            {
                TransactionType = TransactionType.Deposit,
                ...
                TransactionTimeUtc = DateTime.ParseExact("02/01/2026 09:15:00 PM", format, null)
            },
            new Transaction
            {
                TransactionType = TransactionType.Deposit,
                ...
                Amount = 1250.50m,
                Comment = null,
                TransactionTimeUtc = DateTime.ParseExact("02/01/2026 10:00:00 PM", format, null)
            });
