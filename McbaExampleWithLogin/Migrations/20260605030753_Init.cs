        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Account_Balance", "AccountType = 2 and Balance >= 0 or AccountType = 1 and Balance >= -100");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Login_LoginID", "len(LoginID) = 8");
                    table.CheckConstraint("CK_Login_PasswordHash", "len(PasswordHash) = 94");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Transaction_CannotTransferToSelf", "DestinationAccountNumber is null or DestinationAccountNumber != AccountNumber");
                    table.CheckConstraint("CK_Transaction_OnlyTransferCanSetDestination", "TransactionType = 3 or DestinationAccountNumber is null");
                    table.ForeignKey(
